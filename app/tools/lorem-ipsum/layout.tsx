...
export const metadata: Metadata = {
  ...
  description: 'Free Lorem Ipsum generator. Create placeholder text for designs and prototypes. Customizable word and paragraph counts. No ads.',
  ...
  openGraph: {
    ...
    description: 'Free Lorem Ipsum generator. No ads.',
  },
};
