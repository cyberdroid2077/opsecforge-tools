...
faqs:
  - question: "Are passwords generated by browser tools truly random?"
    answer: "Yes, when using a CSPRNG (Cryptographically Secure Pseudo-Random Number Generator). The OpsecForge Password Generator uses crypto.getRandomValues() from the Web Crypto API, which is seeded by your OS's entropy source."
  - question: "Is it safe to generate passwords online?"
    answer: "Only if the tool runs entirely in your browser. If the tool sends your generated password to a server, it is compromised. Always verify the tool is client-side before generating passwords."
  - question: "What is the minimum safe password length?"
    answer: "A minimum of 16 characters is recommended for most accounts. High-value accounts (email, password manager) should use 24+ characters. Length is more important than character complexity."
---
